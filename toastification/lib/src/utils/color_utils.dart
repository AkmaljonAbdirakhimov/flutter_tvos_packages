...
extension IntColorComponents on Color {
  ...
  int get intAlpha => _floatToInt8(alpha.toDouble());

  /// Red component as an 8-bit integer (0-255)
  int get intRed => _floatToInt8(red.toDouble());

  /// Green component as an 8-bit integer (0-255)
  int get intGreen => _floatToInt8(green.toDouble());

  /// Blue component as an 8-bit integer (0-255)
  int get intBlue => _floatToInt8(blue.toDouble());
